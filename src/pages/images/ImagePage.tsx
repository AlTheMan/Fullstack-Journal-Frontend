...
const ImagesPage: React.FC = () => {
  ...
  const mockArr: string[] = [
    ...
    "https://upload.wikimedia.org/wikipedia/commons/3/3c/Anefo_932-2378_Keke_Rosberg%2C_Zandvoort%2C_03-07-1982_-_Restoration.jpg",
    "Hej3",
  ];
      ...
      {displayImage && (
        <div>
          <div className="horizontalCenterWithTopMargin">
            <CanvasComponent imageUrl={mockImage} canvasRef={canvasRef}></CanvasComponent>
          </div>
        </div>
      )}
    </>
